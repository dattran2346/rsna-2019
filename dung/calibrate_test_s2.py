...
if __name__ == "__main__":
    ...
    test_files = ['EfficientnetB2_yp_test_s2_fold0_epoch5.csv',
            'EfficientnetB2_yp_test_s2_fold1_epoch11.csv',
            'EfficientnetB2_yp_test_s2_fold2_epoch11.csv',
            'EfficientnetB2_yp_test_s2_fold3_epoch11.csv',
            'EfficientnetB2_yp_test_s2_fold4_epoch11.csv',
            'EfficientnetB5_yp_test_s2_fold0_epoch11.csv',
            'EfficientnetB5_yp_test_s2_fold1_epoch11.csv',
            'EfficientnetB5_yp_test_s2_fold2_epoch11.csv',
            'EfficientnetB5_yp_test_s2_fold3_epoch11.csv',
            'EfficientnetB5_yp_test_s2_fold4_epoch10.csv']
    for fold in range(5):
        for mfile in test_files:
            ...
            ##################################################################################################
            metadata = pd.read_csv(rsna.conf.stage2_metadata)
