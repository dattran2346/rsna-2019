...
model_train_dict = {
      0: ['../dung/stage2_train/EfficientnetB2_yp_valid_fold0_epoch5.csv',
          '../dung/stage2_train/EfficientnetB5_yp_valid_fold0_epoch11.csv',
          '../datnt/stage2_train/datnt_version3_seresnext50_fold0.csv',
          '../nghia/stage2_train/valid_exp25_fold0_lstm.csv',
          '../nhannt/stage2_train/val_blseresnext50_32x4d_a2_b4_bilstm_fold0.csv',
          '../nhannt/stage2_train/val_se_resnext101_32x4d_bilstm_fold0.csv',
          '../nhannt/stage2_train/val_blseresnext101_32x4d_a2_b4_bilstm_fold0.csv'],

      1: ['../dung/stage2_train/EfficientnetB2_yp_valid_fold1_epoch11.csv',
          '../dung/stage2_train/EfficientnetB5_yp_valid_fold1_epoch11.csv',
          '../datnt/stage2_train/datnt_version3_seresnext50_fold1.csv',
          '../nghia/stage2_train/valid_exp25_fold1_lstm.csv',
          '../nhannt/stage2_train/val_blseresnext50_32x4d_a2_b4_bilstm_fold1.csv',
          '../nhannt/stage2_train/val_se_resnext101_32x4d_bilstm_fold1.csv',
          '../nhannt/stage2_train/val_blseresnext101_32x4d_a2_b4_bilstm_fold1.csv'],

      2: ['../dung/stage2_train/EfficientnetB2_yp_valid_fold2_epoch11.csv',
          '../dung/stage2_train/EfficientnetB5_yp_valid_fold2_epoch11.csv',
          '../datnt/stage2_train/datnt_version3_seresnext50_fold2.csv',
          '../nghia/stage2_train/valid_exp25_fold2_lstm.csv',
          '../nhannt/stage2_train/val_blseresnext50_32x4d_a2_b4_bilstm_fold2.csv',
          '../nhannt/stage2_train/val_se_resnext101_32x4d_bilstm_fold2.csv',
          '../nhannt/stage2_train/val_blseresnext101_32x4d_a2_b4_bilstm_fold2.csv'],

      3: ['../dung/stage2_train/EfficientnetB2_yp_valid_fold3_epoch11.csv',
          '../dung/stage2_train/EfficientnetB5_yp_valid_fold3_epoch11.csv',
          '../datnt/stage2_train/datnt_version3_seresnext50_fold3.csv',
          '../nghia/stage2_train/valid_exp25_fold3_lstm.csv',
          '../nhannt/stage2_train/val_blseresnext50_32x4d_a2_b4_bilstm_fold3.csv',
          '../nhannt/stage2_train/val_se_resnext101_32x4d_bilstm_fold3.csv',
          '../nhannt/stage2_train/val_blseresnext101_32x4d_a2_b4_bilstm_fold3.csv'],

      4: ['../dung/stage2_train/EfficientnetB2_yp_valid_fold4_epoch11.csv',
          '../dung/stage2_train/EfficientnetB5_yp_valid_fold4_epoch10.csv',
          '../datnt/stage2_train/datnt_version3_seresnext50_fold4.csv',
          '../nghia/stage2_train/valid_exp25_fold4_lstm.csv',
          '../nhannt/stage2_train/val_blseresnext50_32x4d_a2_b4_bilstm_fold4.csv',
          '../nhannt/stage2_train/val_se_resnext101_32x4d_bilstm_fold4.csv',
          '../nhannt/stage2_train/val_blseresnext101_32x4d_a2_b4_bilstm_fold4.csv'],
}
...
if __name__ == "__main__":
    ...
    df = pd.read_csv('../dung/dataset/trainset_s2.csv')
