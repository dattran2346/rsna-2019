...
model_train_dict = {
    0: ['../datnt/stage2_train/datnt_version4_b3_fold0.csv',
        '../datnt/stage2_train/datnt_version4_b4_fold0.csv',
        '../nhannt/stage2_train/val_tf_efficientnet_b3_bigru_patient_fold0.csv',
        '../dattq/stage2_train/val_resnext50_32x4d_fold0_x256_tta3.csv',
        '../dattq/stage2_train/val_resnext101_32x4d_fold0_x384_tta3.csv'],

    1: ['../datnt/stage2_train/datnt_version4_b3_fold1.csv',
        '../datnt/stage2_train/datnt_version4_b4_fold1.csv',
        '../nhannt/stage2_train/val_tf_efficientnet_b3_bigru_patient_fold1.csv',
        '../dattq/stage2_train/val_resnext50_32x4d_fold1_x256_tta3.csv',
        '../dattq/stage2_train/val_resnext101_32x4d_fold1_x384_tta3.csv'],

    2: ['../datnt/stage2_train/datnt_version4_b3_fold2.csv',
        '../datnt/stage2_train/datnt_version4_b4_fold2.csv',
        '../nhannt/stage2_train/val_tf_efficientnet_b3_bigru_patient_fold2.csv',
        '../dattq/stage2_train/val_resnext50_32x4d_fold2_x256_tta3.csv',
        '../dattq/stage2_train/val_resnext101_32x4d_fold2_x384_tta3.csv'],

    3: ['../datnt/stage2_train/datnt_version4_b3_fold3.csv',
        '../datnt/stage2_train/datnt_version4_b4_fold3.csv',
        '../nhannt/stage2_train/val_tf_efficientnet_b3_bigru_patient_fold3.csv',
        '../dattq/stage2_train/val_resnext50_32x4d_fold3_x256_tta3.csv',
        '../dattq/stage2_train/val_resnext101_32x4d_fold3_x384_tta3.csv'],

    4: ['../datnt/stage2_train/datnt_version4_b3_fold4.csv',
        '../datnt/stage2_train/datnt_version4_b4_fold4.csv',
        '../nhannt/stage2_train/val_tf_efficientnet_b3_bigru_patient_fold4.csv',
        '../dattq/stage2_train/val_resnext50_32x4d_fold4_x256_tta3.csv',
        '../dattq/stage2_train/val_resnext101_32x4d_fold4_x384_tta3.csv'],
}
...
if __name__ == "__main__":
    ...
    for fold in args.folds:
        ...
        valid_df = pd.read_csv('s2train_patient_df/valid_patient_df_fold{}.csv'.format(fold), usecols=['image','any','epidural','intraparenchymal','intraventricular','subarachnoid','subdural'])
