...
studyid_test_dict = {
      0: ['../dung/calib_pred/EfficientnetB2_yp_test_fold0_epoch5.csv',
          ...
          '../nhannt/raw_pred/test_blseresnext50_32x4d_a2_b4_bilstm_fold0.csv',
          '../nhannt/raw_pred/test_se_resnext101_32x4d_bilstm_fold0.csv',
          '../nhannt/raw_pred/test_blseresnext101_32x4d_a2_b4_bilstm_fold0.csv'],

      1: ['../dung/calib_pred/EfficientnetB2_yp_test_fold1_epoch11.csv',
          ...
          '../nhannt/raw_pred/test_blseresnext50_32x4d_a2_b4_bilstm_fold1.csv',
          '../nhannt/raw_pred/test_se_resnext101_32x4d_bilstm_fold1.csv',
          '../nhannt/raw_pred/test_blseresnext101_32x4d_a2_b4_bilstm_fold1.csv'],

      2: ['../dung/calib_pred/EfficientnetB2_yp_test_fold2_epoch11.csv',
          ...
          '../nhannt/raw_pred/test_blseresnext50_32x4d_a2_b4_bilstm_fold2.csv',
          '../nhannt/raw_pred/test_se_resnext101_32x4d_bilstm_fold2.csv',
          '../nhannt/raw_pred/test_blseresnext101_32x4d_a2_b4_bilstm_fold2.csv'],

      3: ['../dung/calib_pred/EfficientnetB2_yp_test_fold3_epoch11.csv',
          ...
          '../nhannt/raw_pred/test_blseresnext50_32x4d_a2_b4_bilstm_fold3.csv',
          '../nhannt/raw_pred/test_se_resnext101_32x4d_bilstm_fold3.csv',
          '../nhannt/raw_pred/test_blseresnext101_32x4d_a2_b4_bilstm_fold3.csv'],

      4: ['../dung/calib_pred/EfficientnetB2_yp_test_fold4_epoch11.csv',
          ...
          '../nhannt/raw_pred/test_blseresnext50_32x4d_a2_b4_bilstm_fold4.csv',
          '../nhannt/raw_pred/test_se_resnext101_32x4d_bilstm_fold4.csv',
          '../nhannt/raw_pred/test_blseresnext101_32x4d_a2_b4_bilstm_fold4.csv'],
}

patientid_train_dict = {
    0: ['../datnt/windowed_csv/test/datnt_version4_b3_fold0.csv',
        '../datnt/windowed_csv/test/datnt_version4_b4_fold0.csv',
        '../nhannt/raw_pred/test_tf_efficientnet_b3_bigru_patient_fold0.csv',
        '../dattq/raw_pred/test_resnext50_32x4d_fold0_x256_tta3.csv',
        '../dattq/raw_pred/test_resnext101_32x4d_fold0_x384_tta3.csv'],

    1: ['../datnt/windowed_csv/test/datnt_version4_b3_fold1.csv',
        '../datnt/windowed_csv/test/datnt_version4_b4_fold1.csv',
        '../nhannt/raw_pred/test_tf_efficientnet_b3_bigru_patient_fold1.csv',
        '../dattq/raw_pred/test_resnext50_32x4d_fold1_x256_tta3.csv',
        '../dattq/raw_pred/test_resnext101_32x4d_fold1_x384_tta3.csv'],

    2: ['../datnt/windowed_csv/test/datnt_version4_b3_fold2.csv',
        '../datnt/windowed_csv/test/datnt_version4_b4_fold2.csv',
        '../nhannt/raw_pred/test_tf_efficientnet_b3_bigru_patient_fold2.csv',
        '../dattq/raw_pred/test_resnext50_32x4d_fold2_x256_tta3.csv',
        '../dattq/raw_pred/test_resnext101_32x4d_fold2_x384_tta3.csv'],

    3: ['../datnt/windowed_csv/test/datnt_version4_b3_fold3.csv',
        '../datnt/windowed_csv/test/datnt_version4_b4_fold3.csv',
        '../nhannt/raw_pred/test_tf_efficientnet_b3_bigru_patient_fold3.csv',
        '../dattq/raw_pred/test_resnext50_32x4d_fold3_x256_tta3.csv',
        '../dattq/raw_pred/test_resnext101_32x4d_fold3_x384_tta3.csv'],

    4: ['../datnt/windowed_csv/test/datnt_version4_b3_fold4.csv',
        '../datnt/windowed_csv/test/datnt_version4_b4_fold4.csv',
        '../nhannt/raw_pred/test_tf_efficientnet_b3_bigru_patient_fold4.csv',
        '../dattq/raw_pred/test_resnext50_32x4d_fold4_x256_tta3.csv',
        '../dattq/raw_pred/test_resnext101_32x4d_fold4_x384_tta3.csv'],
}

print('args:',args)
if __name__ == "__main__":
    test_df = pd.read_csv('../dung/dataset/testset_stage1.csv')
    ...
    # tmp_df.to_csv('patient_ft_study.csv', index=False)
