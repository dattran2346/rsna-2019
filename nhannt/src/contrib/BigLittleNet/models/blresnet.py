...
__all__ = ['bLResNet', 'blresnet50_a2_b4', 'blresnet101_a2_b4']
...
def _blresnet_model(depth, alpha=2, beta=4, num_classes=1000, pretrained=False):
    layers = {
        50: [3, 4, 6, 3],
        101: [4, 8, 18, 3],
        152: [5, 12, 30, 3]
...
def blresnet50_a2_b4(pretrained=False, **kwargs):
    kwargs["depth"] = 50
    kwargs["pretrained"] = pretrained
    return _blresnet_model(**kwargs)


def blresnet101_a2_b4(pretrained=False, **kwargs):
    kwargs["depth"] = 101
    kwargs["pretrained"] = pretrained
    return _blresnet_model(**kwargs)