...
__all__ = ['bLSEResNeXt', 'blseresnext50_32x4d_a2_b4', 'blseresnext101_32x4d_a2_b4']
...
def _blseresnext_model(depth, basewidth, cardinality, alpha=2, beta=4,
...
def blseresnext50_32x4d_a2_b4(pretrained=False, **kwargs):
    """
    SEResNeXt-50 32x4d model from
    ...
    return _blseresnext_model(**kwargs)


def blseresnext101_32x4d_a2_b4(pretrained=False, **kwargs):
    """
    SEResNeXt-101 32x4d model from
    `"Big-Little Net: An Efficient Multi-Scale Feature Representation for Visual and Speech Recognition" <https://arxiv.org/pdf/1807.03848.pdf>`_
